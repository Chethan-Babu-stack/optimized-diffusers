...
The U-net architecture begins by taking an image as input. It then proceeds to extract features while downsampling,
followed by refining these downsampled features. Finally, it upsamples the refined features to reconstruct an image of
